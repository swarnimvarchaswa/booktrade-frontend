  ...
  return (
    <div className="lg:w-4/5 w-full fixed right-0 rounded">
      ...
      >
        ...
        <div className="fixed bottom-0 bg-slate-50 pb-6 pt-2 pl-[3vw] pr-[3vw] flex items-center w-full">
          <input
            className="py-3 pl-3 pr-14 w-full lg:w-[74vw] rounded-lg bg-gray-200 focus:outline-none font-r lg:text-lg text-base placeholder-gray-700"
          ...
          />
          <button
            className="w-fit relative right-[56px] text-purple-700 cursor-pointer lg:right-[60px]"
            onClick={handleSendMessage}
          >
            <SendIcon />
          </button>
